...
use QuantaForge\Contracts\Queue\Factory as QueueManager;
...
use QuantaForge\Queue\Events\JobTimedOut;
use QuantaForge\Queue\Events\Looping;
use QuantaForge\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @param  \QuantaForge\Contracts\Queue\Factory  $manager
     * @param  \QuantaForge\Contracts\Events\Dispatcher  $events
     * @param  \QuantaForge\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \QuantaForge\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Queue\Queue  $connection
     * @param  string  $queue
    ...
    {
        if ($this->cache) {
            return $this->cache->get('quantaforge:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \QuantaForge\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Queue\Job  $job
     * @return \QuantaForge\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \QuantaForge\Contracts\Queue\Job  $job
     * @return \QuantaForge\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \QuantaForge\Contracts\Queue\Factory
     */

...
class ListenCommand extends Command
{
     ...
     *
     * @var \QuantaForge\Queue\Listener
     */
    protected $listener;
     ...
     *
     * @param  \QuantaForge\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->quantaforge['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->quantaforge['config']->get(
     ...
     *
     * @return \QuantaForge\Queue\ListenerOptions
     */

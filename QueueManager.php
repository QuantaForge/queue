...
use Closure;
use QuantaForge\Contracts\Queue\Factory as FactoryContract;
use QuantaForge\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param  string  $driver
     * @return \QuantaForge\Queue\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */

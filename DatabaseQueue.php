...
use QuantaForge\Contracts\Queue\ClearableQueue;
use QuantaForge\Contracts\Queue\Queue as QueueContract;
use QuantaForge\Database\Connection;
use QuantaForge\Queue\Jobs\DatabaseJob;
use QuantaForge\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \QuantaForge\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \QuantaForge\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \QuantaForge\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \QuantaForge\Queue\Jobs\DatabaseJobRecord  $job
     * @return \QuantaForge\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \QuantaForge\Queue\Jobs\DatabaseJobRecord  $job
     * @return \QuantaForge\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \QuantaForge\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
